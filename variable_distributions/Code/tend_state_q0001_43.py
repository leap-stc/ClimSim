...
for variable in outvarlist:
    ...
    sfile_path = 'mlo_'+variable+'_lev_43'+'.txt'
    sfile_path = 'mli_'+variable+'_lev_43'+'.txt'
    file = open(sfile_path, 'w')
    file_path1=DATAPATH1+"ne30.mlo."+variable+".lev-43*.nc"
    file_path2=DATAPATH2+"ne30.mli."+variable+".lev-43*.nc"
    ...
    plt.xlabel(variable+" level:43")
    plt.ylabel('Frequency')
    plt.title('Histogram')
    # Save the histogram to a file
    plt.savefig('tend'+variable+'_lev_43_tend.png')
