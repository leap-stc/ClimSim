...
for variable in outvarlist:
    ...
    sfile_path = 'mlo_'+variable+'_lev_1'+'.txt'
    sfile_path = 'mli_'+variable+'_lev_1'+'.txt'
    file = open(sfile_path, 'w')
    file_path1=DATAPATH1+"ne30.mlo."+variable+".lev-1*.nc"
    file_path2=DATAPATH2+"ne30.mli."+variable+".lev-1*.nc"
