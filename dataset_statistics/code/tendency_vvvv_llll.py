...
for variable in outvarlist:
    ...
    sfile_path = 'tend_'+variable+'_lev_lllllll'+'.txt'
    file = open(sfile_path, 'w')
    file_path1=DATAPATH1+"ne30.mlo."+variable+".lev-lllllll*.nc"
    file_path2=DATAPATH2+"ne30.mli."+variable+".lev-lllllll*.nc"
    ...
    plt.xlabel(variable+" level:lllllll")
    plt.ylabel('Frequency')
    plt.title('Histogram')
    # Save the histogram to a file
    plt.savefig('tend'+variable+'_lev_lllllll_tend.png')
